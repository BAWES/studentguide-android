...
public class SubCategoryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    SubCategoryListAdapter mCategoryListAdapter;
...
//        SearchClickFunction();
    ...
    private void showCategotyList() {
        mCategoryListAdapter = new SubCategoryListAdapter(SubCategoryActivity.this, mCategoryList);
        ...
        vCategory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent inCategory = new Intent(SubCategoryActivity.this, VendorActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.LFT_IV_home:
                ControllerClass.CallScreen(SubCategoryActivity.this, ChooseLanguage.class);
                finish();
                break;
            case R.id.LFT_IV_message:
                ControllerClass.CallScreen(SubCategoryActivity.this, ContactUsActivity.class);
                finish();
                break;
        }
    }
